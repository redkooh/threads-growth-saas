...
const BATCH_PRESETS = {
  'general': { content_style: 'auto', post_tone: 'friendly', post_length: 'auto', target_niche: 'General / broad audience', topic_keywords: 'trending, viral, lifestyle, popular, relatable, daily life', reply_keywords: 'trending, viral, relatable, popular, thoughts, opinion', target_threads: 10, target_replies: 50, sleep_hours_start: 23, sleep_hours_end: 6, reply_tone: 'value_add' },
  'tech-saas': { content_style: 'auto', post_tone: 'professional', post_length: 'auto', target_niche: 'Tech / SaaS founders', topic_keywords: 'startups, SaaS, AI, entrepreneurship, growth', reply_keywords: 'startup, SaaS, AI, funding, product', target_threads: 10, target_replies: 50, sleep_hours_start: 23, sleep_hours_end: 5 },
  'fitness': { content_style: 'auto', post_tone: 'inspirational', post_length: 'auto', target_niche: 'Fitness / health enthusiasts', topic_keywords: 'workout, fitness, health, nutrition, gym', reply_keywords: 'workout, gym, fitness, diet, protein', target_threads: 10, target_replies: 50, sleep_hours_start: 0, sleep_hours_end: 6 },
  'business': { content_style: 'auto', post_tone: 'professional', post_length: 'auto', target_niche: 'Business owners / entrepreneurs', topic_keywords: 'business, marketing, sales, leadership, growth', reply_keywords: 'business, revenue, marketing, sales, strategy', target_threads: 10, target_replies: 50, sleep_hours_start: 23, sleep_hours_end: 5 },
  'casual': { content_style: 'auto', post_tone: 'friendly', post_length: 'auto', target_niche: 'General audience', target_threads: 10, target_replies: 50, sleep_hours_start: 23, sleep_hours_end: 6 },
  'reset': { content_style: 'auto', post_tone: 'friendly', post_length: 'auto', post_format: 'text', target_threads: 10, target_replies: 50, max_threads: 10, max_replies: 50, sleep_hours_start: 23, sleep_hours_end: 6, viral_threshold: 0, reply_tone: 'value_add', reply_length: 'medium', topic_keywords: '', avoid_topics: '', reply_keywords: '', target_niche: '', links_enabled: false },
};
